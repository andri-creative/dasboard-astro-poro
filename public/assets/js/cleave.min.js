        ...
        ((i.prototype = {
              ...
              r.phone
                ...
                : r.numeral
                  ...
                  : (r.date && (e = r.dateFormatter.getValidatedDate(e)),
                    ...
                    r.prefix &&
                    (r.tailPrefix ? (e += r.prefix) : (e = r.prefix + e), 0 === r.blocksLength)
          ...
          callOnValueChanged: function () {
            ...
            t.onValueChanged.call(e, {
              target: { name: e.element.name, value: t.result, rawValue: e.getRawValue() },
            });
          },
        ...
        getRangeFixedDate: function (e) {
          ...
          return !e.length || (i.length < 3 && n.length < 3)
            ...
            : r.find(function (e) {
              ...
              : n.length &&
                  (n[2] < e[2] ||
                    (n[2] === e[2] && (n[1] < e[1] || (n[1] === e[1] && n[0] < e[0]))))
                ? n
                : i.length &&
                    (i[2] > e[2] ||
      ...
      ((r.prototype = {
        ...
        getISOFormatTime: function () {
          var e = this,
            t = e.time;
          return t[2]
            ? e.addLeadingZero(t[0]) + ":" + e.addLeadingZero(t[1]) + ":" + e.addLeadingZero(t[2])
            : "";
        },
        getBlocks: function () {
          return this.blocks;
        ...
        var r = {
          assign: function (e, r) {
            return (
              ...
              (e.initValue =
                void 0 !== r.initValue && null !== r.initValue ? r.initValue.toString() : ""),
              (e.delimiter =
