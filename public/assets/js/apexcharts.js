          ...
          [
            {
              ...
              value: function (t, e) {
                ...
                var o = t
                    ...
                    .reduce(function (t, e) {
                      return (
                        parseFloat(e) == e && t.length ? t[t.length - 1].push(e) : t.push([e]),
                        t
                      );
                    }, []),
                  n = [];
            ...
            value: function (t) {
              ...
              for (var x = 0; x < a.x.length; x++)
                if (((g = a.x[x] + d.offsetX), (u = a.y[x] + d.offsetY + l), !isNaN(g))) {
                  ...
                  "rangeArea" === i &&
                    (b = o ? h.globals.seriesRangeStart[s][f] : h.globals.seriesRangeEnd[s][f]);
                  var v = "",
                    y = function (t) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                (f &&
                  (p = this.dataLabelsCorrection(a, s, n, r, o, u, parseInt(d.style.fontSize, 10))),
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                this.ctx.legend.legendHelpers.toggleDataSeries(e.realIndex, e.isHidden),
                e.isHidden
              );
            },
          },
          ...
          },
          {
            ...
            value: function () {
              ...
              (["line", "area", "bar", "rangebar", "rangeArea", "candlestick", "radar"].forEach(
                function (i) {
                  for (
                    var a,
                      s =
                ...
                if (
                  (("rangeBar" !== a.chart.type &&
                    ...
                    s.isComboCharts
                      ...
                      : ("rangeBar" !== a.chart.type && "rangeArea" !== a.chart.type) ||
                        this.handleRangeData(t, l)),
                  this.isMultiFormat())
                )
                  (this.isFormat2DArray()
                    ...
                    for (var a = 0; a < t.data.length; a++) {
                      ...
                      if (
                        (s ||
                          (p.isFormatXY()
                            ? (s = i[e].data[a].x)
                            : p.isFormat2DArray() && (s = i[e].data[a] ? i[e].data[a][0] : "")),
                        0 === e)
                      ) {
                        h.push(
                          ((n = s),
                    ...
                    : "rangeBar" === l.config.chart.type
                      ...
                      : i.map(function (t, e) {
                          ...
                          l.globals.axisCharts &&
                            h.push(i.split(r).join("") ? i.split(r).join("") : "series-".concat(e));
                        }),
                l.globals.axisCharts ||
                  (h.push(l.config.chart.toolbar.export.csv.headerValue), c.push(h.join(r))),
                i.map(function (t, e) {
                  l.globals.axisCharts
                    ? m(t, e)
    ...
    V = (function () {
      function t(e, i) {
        ...
        ((this.axesUtils = new B(e)),
          ...
          this.isCategoryBarHorizontal &&
            (this.xaxisBorderWidth = s.config.yaxis[0].axisBorder.width.toString()),
                      ...
                      (a.yaxis.opposite && (p = "start"),
                        "left" === s.config.yaxis[0].labels.align
                          ...
                          : "center" === s.config.yaxis[0].labels.align
                            ...
                            : "right" === s.config.yaxis[0].labels.align && (p = "end"));
                      var x = r.drawText({
                        x: f,
                        y: i + e + g.offsetY - u,
                        text: n,
        ...
        r(t, [
          ...
          },
          {
            ...
            value: function () {
              var t = null;
              return (
                this.w.globals.axisCharts && ((t = this.renderGrid()), this.drawGridArea(t.el)),
                t
              );
            },
          },
            ...
            value: function (t) {
              ...
              ((p = a[e].children),
                l.config.tooltip.fillSeriesColor &&
                  ((a[e].style.backgroundColor = n), (p[0].style.display = "none")),
                h.showTooltipTitle &&
                  (null === h.tooltipTitle &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              a.globals.isXNumeric && "datetime" === a.config.xaxis.type
                ? (r = new M(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, {
                    i: void 0,
                    dateFormatter: new T(this.ctx).formatDate,
                    w: this.w,
                  }))
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ("0" !== s.getAttribute("default-marker-size")) {
                ...
                (void 0 === a &&
                  (a = i.globals.markers.size[r] + i.config.markers.hover.sizeOffset),
                  a < 0 && (a = 0),
                  s.setAttribute("r", a));
              }
            },
            ...
            value: function (t, i, a, s, r) {
              ...
              if (A) {
                ...
                (C.tooltipLabels.drawSeriesTexts(e({ shared: !1 }, F)),
                  this.tooltipUtil.hasBars() && C.tooltipPosition.moveStickyTooltipOverBars(s),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var A = this.barCtx.series[r][o] < 0,
                S = l;
              switch (
                (this.barCtx.isReversed && ((S = l - d + (A ? 2 * d : 0)), (l -= d)), p.position)
              ) {
                case "center":
                  u = w
                    ? A
              ...
              return (
                s.config.chart.stacked ||
                  (u < 0
                    ? (u = 0 + b)
                    : u + g.height / 3 > s.globals.gridHeight && (u = s.globals.gridHeight - b)),
                {
                  bcx: h,
                  bcy: l,
                  dataLabelsX: e,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (this.barCtx.lastActiveBarSerieIndex === r && f.enabled) {
                ...
                (A
                  ? ((v = S - d + Math.round(C.width / 2) - p - f.offsetX - 15), (k = "end"))
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !b) {
                ...
                var v = "";
                void 0 !== s &&
                  (v = p(s, e(e({}, d), {}, { seriesIndex: r, dataPointIndex: o, w: d })));
            ...
            value: function (t, e, i, a) {
              ...
              return (
                ...
                h.fillPath({
                  ...
                  value: t[e][i],
                  fillConfig:
                    null === (s = l.config.series[e].data[i]) || void 0 === s ? void 0 : s.fill,
                  fillType:
            ...
            value: function (t) {
              ...
              return (
                ...
                (x =
                  ...
                  d.line(p - o, r) +
                  d.line(p - o, s) +
                  ("around" === c.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z")),
                (b =
                  b +
                  d.line(f, s) +
                  v +
                ...
                this.shouldApplyRadius(n) &&
                  (x = d.roundPathCorners(x, c.config.plotOptions.bar.borderRadius)),
                    ...
                    for (var S = 0; S < s.globals.dataPoints; S++) {
                      ...
                      a.isHorizontal
                        ? ((P = a.drawStackedBarPaths(
                            e(e({}, L), {}, { zeroW: u, barHeight: w, yDivision: d })
                          )),
                          (k = a.series[r][S] / a.invertedYRatio))
                        : ((P = a.drawStackedColumnPaths(
                            e(e({}, L), {}, { xDivision: c, barWidth: k, zeroH: g })
                          )),
        ...
        r(t, [
          {
            ...
            value: function (t) {
              ...
              for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
                ...
                for (
                  var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, f = 0;
                  f < l[h].length;
                  f++
                ) {
            ...
            value: function (t) {
              ...
              for (
                ...
                (e.globals.dataChanged &&
                  ((k = this.startAngle),
                  (C =
                    Math.round((this.totalAngle * x.negToZero(e.globals.previousPaths[p])) / 100) +
                    k)),
              ...
              for (var c = [], d = 0; d < t.length; d++) {
                ...
                (this.ctx.series.addCollapsedClassToSeries(this.elSeries, g),
                  r.globals.isXNumeric &&
                    ...
                    (p = (r.globals.seriesX[g][0] - r.globals.minX) / this.xRatio),
                  f.push(p));
                var x,
                  b = p,
                  v = void 0,
              ...
              for (var I = n, z = 0; z < a; z++) {
                ...
                (X
                  ...
                  : ((n =
                      ...
                      2 * (this.isReversed ? i[r][z + 1] / A[this.yaxisIndex] : 0)),
                    "rangeArea" === e &&
                      (I =
                        f -
                        y[r][z + 1] / A[this.yaxisIndex] +
                        2 * (this.isReversed ? y[r][z + 1] / A[this.yaxisIndex] : 0))),
                  p.push(o),
                  b.push(n));
            ...
            value: function (t) {
              ...
              if (
                (Array.isArray(b.config.stroke.curve) &&
                  (y = Array.isArray(p) ? b.config.stroke.curve[p[a]] : b.config.stroke.curve[a]),
                "smooth" === y)
              ) {
                var k = 0.35 * (o - h);
  ...
  ((Xt = "undefined" != typeof window ? window : void 0),
      ...
      ((a.PathArray = function (t, e) {
            ...
            do {
              (a.regex.isPathLetter.test(t[l])
                ...
                : "M" == e
                  ...
                  : "m" == e && (e = "l"),
                r.push(
                  s[e].call(null, t.slice(l, (l += i[e.toUpperCase()])).map(parseFloat), o, n)
                ));
            } while (c > l);
            return r;
          },
        ...
        (a.FX = a.invent({
          ...
          extend: {
            ...
            start: function () {
              return (
                !this.active && this.situation && ((this.active = !0), this.startCurrent()),
                this
              );
            },
    ...
    function () {
      ...
      var t = {
        ...
        merge: function () {
          return (
            this.parent() && this.parent().merge.apply(this.parent(), [this].concat(arguments))
          );
        },
        gaussianBlur: function (t, e) {
      ...
      (["r", "g", "b", "a"].forEach(function (t) {
        ...
        SVG.extend(SVG.MergeEffect, {
          in: function (t) {
            return (
              t instanceof SVG.MergeNode ? this.add(t, 0) : this.add(new SVG.MergeNode(t), 0),
              this
            );
          },
        }),
