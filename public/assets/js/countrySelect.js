...
(function (factory) {
  ...
  Plugin.prototype = {
    ...
    _setInitialState: function () {
      ...
      if (!flagIsSet) {
        ...
        if (this.options.defaultCountry) {
          ...
          typeof this.option.defaultCountry === "null"
        ) {
    ...
    _setDropdownPosition: function () {
      ...
      var cssTop =
        !dropdownFitsBelow && dropdownFitsAbove ? "-" + (this.dropdownHeight - 1) + "px" : "";
    ...
    _filterCountries: function (letters) {
      var countries = this.countryListItems.filter(function () {
        return (
          $(this).text().toUpperCase().indexOf(letters) === 0 && !$(this).hasClass("preferred")
        );
      });
      if (countries.length) {
    ...
    _selectFlag: function (countryCode) {
      var countryData = !countryCode
        ? this._getCountryData(countryCode, true)
        : this._getCountryData(countryCode);
