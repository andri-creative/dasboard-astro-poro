...
var FullCalendar = (function (e) {
  ...
  function E(e) {
    ((!e.__d && (e.__d = !0) && s.push(e) && !S.__r++) || o !== n.debounceRendering) &&
    ...
    for (n.__k = [], h = 0; h < t.length; h++)
      if (
        ...
        (k(e, v, (p = p || l), i, s, o, a, d, u),
          ...
          (f = v.ref) &&
            p.ref != f &&
            (S || (S = []), p.ref && S.push(p.ref, null, v), S.push(f, v.__c || b, v)),
          null != b
            ? (null == E && (E = b),
  ...
  function D(e, t, n) {
    for (var r, i = e.__k, s = 0; i && s < i.length; s++)
      (r = i[s]) &&
        ((r.__ = e), (t = "function" == typeof r.type ? D(r, t, n) : C(n, r, r, i, r.__e, t)));
    return t;
  }
  function w(e, t) {
    return (
        ...
        if (
          ...
          r.__c
            ...
            : ("prototype" in T && T.prototype.render
                ? (t.__c = h = new T(E, D))
                : ((t.__c = h = new v(E, D)), (h.constructor = T), (h.render = P)),
              S && S.sub(h),
              (h.props = E),
              h.state || (h.state = {}),
              (h.context = D),
  ...
  function I(e, n, r, i, s, o, a, c) {
    ...
    if (null === m) g === p || (c && e.data === p) || (e.data = p);
      ...
      c ||
        ("value" in p &&
          void 0 !== (v = p.value) &&
          (v !== e.value || ("progress" === m && !v) || ("option" === m && v !== g.value)) &&
  ...
  ((t = c.slice),
    ...
    (v.prototype.setState = function (e, t) {
      var n;
      ((n =
        null != this.__s && this.__s !== this.state ? this.__s : (this.__s = u({}, this.state))),
  ...
  function Pt(e, t, n = !1) {
    ...
    return (
      ...
      r.length > 10 &&
        (null == t ? (r = r.replace("Z", "")) : 0 !== t && (r = r.replace("Z", zt(t, !0)))),
      r
    );
  }
  function Ht(e) {
  ...
  class Mn {
    ...
    createMarkerMeta(e) {
      ...
      return (
        ...
        null !== t && Ot(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } : null
      );
    }
    parse(e) {
      let t = kn(e);
    ...
    toDate(e, t) {
      return "local" === this.timeZone
        ...
        : "UTC" === this.timeZone
          ? new Date(e.valueOf())
          : this.namedTimeZoneImpl
            ? new Date(e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(Mt(e)) * 60)
  ...
  class zn extends v {
    ...
    safeSetState(e) {
      Dn(this.state, Object.assign(Object.assign({}, this.state), e), this.stateEquality) ||
        this.setState(e);
    }
  }
  ...
  function sr(e, t = lt(0)) {
    ...
    return (e.start && ((n = Rt(e.start)), r && r <= n && (r = bt(n, 1))), { start: n, end: r });
  }
  function or(e) {
    let t = sr(e);
  ...
  class cr {
    ...
    buildRangeFromDuration(e, t, n, r) {
      ...
      return (
        ht(n) <= 1 && this.isHiddenDay(i) && ((i = this.skipHiddenDays(i, t)), (i = Rt(i))),
        c(),
    ...
    buildDateIncrement(e) {
      ...
      return n || ((t = this.props.dateAlignment) ? lt(1, t) : e || lt({ days: 1 }));
    }
    refineRange(e) {
      if (e) {
        let t = (function (e, t) {
  ...
  function qr(e, t, n, r, i) {
    ...
    return (
      ...
      t.allDay && (l.range = { start: Rt(l.range.start), end: Rt(l.range.end) }),
  ...
  class Zr {
    ...
    setProp(e, t) {
      ...
      else if ("id" === e) ((t = fr[e](t)), this.mutate({ standardProps: { publicId: t } }));
      else if (e in fr) ((t = fr[e](t)), this.mutate({ standardProps: { [e]: t } }));
      else if (e in xr) {
        let n = xr[e](t);
        ((n =
          "color" === e
  ...
  class _i {
    ...
    select(e, t) {
      ...
      i && (this.dispatch({ type: "SELECT_DATES", selection: i }), Lr(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
    ...
    addEventSource(e) {
      ...
      let n = Or(e, t);
      return n ? (this.dispatch({ type: "ADD_EVENT_SOURCES", sources: [n] }), new Yr(t, n)) : null;
    }
  ...
  function qi(e, t = !1) {
    ...
    return (
      Vi() && "rtl" === n.direction ? (c.scrollbarLeft = l) : (c.scrollbarRight = l),
      t &&
  ...
  class rs {
    ...
    splitEntry(e, t, n) {
      ...
      return (
        ...
        r
          ? (n.push({ index: e.index, thickness: e.thickness, span: as(o, s) }, ...i), r)
          : (n.push(e), 0)
      );
    }
    insertEntryAt(e, t) {
  ...
  class vs extends Un {
    render() {
      let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context,
        ...
        u = Object.assign(
          Object.assign(Object.assign({ date: e.toDate(s), view: r }, i.extraRenderProps), {
            text: c,
          }),
          a
        );
  ...
  class ws {
    constructor(e, t) {
      let n = e.start,
        ...
        o = -1;
      for (; n < r; )
        (t.isHiddenDay(n) ? i.push(o + 0.5) : ((o += 1), i.push(o), s.push(n)), (n = bt(n, 1)));
  ...
  function to(e) {
    return f(
      ...
      f(
        ...
        f("div", { className: "fc-event-title fc-sticky" }, e.event.title || f(m, null, " "))
      )
    );
  }
  const no = (e) =>
      ...
      return ce(
        f(
          ...
          f(
            ...
            f("span", { className: "fc-popover-title", id: r.titleId }, n.title),
            f("span", {
          ...
          f("div", { className: "fc-popover-body " + e.getClass("popoverContent") }, n.children)
        ),
        n.parentEl
      );
    }
      ...
      return f(
        ...
        (t, r, i) =>
          f(
            ...
            so(e) && f(t, { elTag: "div", elClasses: ["fc-more-popover-misc"] }),
            n.children
          )
      );
    }
          ...
          Boolean(e.moreCnt) &&
            f(
              qn,
              {
                ...
                elStyle: e.elStyle,
                elAttrs: Object.assign(
                  Object.assign(Object.assign({}, e.elAttrs), We(this.handleClick)),
                  {
                    title: d,
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            bi(e.eventSource.meta.bind(null, vi(e.range, r)), (e) => t({ rawEvents: e }), n);
          },
        },
      ],
    }),
  ...
  class sa {
    ...
    processRawViewOptions(e, t, n, r, i) {
      let s = un([rn, e.optionDefaults, n, r, e.optionOverrides, i]),
        o = Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign(Object.assign({}, nn), sn), on), dn),
            t.listenerRefiners
          ),
          t.optionRefiners
        ),
  ...
  class ma extends Un {
    ...
    renderWidgetGroup(e) {
      ...
      for (let s of e) {
        ...
        if ("title" === e)
          ((i = !1), r.push(f("h2", { className: "fc-toolbar-title", id: t.titleId }, t.title)));
        else {
      ...
      if (r.length > 1) {
        return f("div", { className: (i && n.getClass("buttonGroup")) || "" }, ...r);
      }
      return r[0];
    }
  }
  ...
  function wa(e) {
    ...
    return new Mn(
      Object.assign(Object.assign({ timeZone: rn.timeZone, calendarSystem: "gregory" }, e), {
        locale: t,
      })
    );
  }
      ...
      class extends Ci {
        constructor(e) {
          (super(e),
            ...
            (this.handlePointerUp = (e) => {
              this.dragSelection &&
                (Lr(this.dragSelection, e, this.component.context), (this.dragSelection = null));
            }));
          let { component: t } = e,
            { options: n } = t.context,
            r = (this.dragging = new Ha(e.el));
  ...
  function tl(e) {
    return f(
      ...
      e.timeText && f("div", { className: "fc-event-time" }, e.timeText),
      f("div", { className: "fc-event-title" }, e.event.title || f(m, null, " "))
    );
  }
  class nl extends Un {
    constructor() {
          ...
          (y &&
            ...
            h.push(
              f(
                ...
                {
                  className:
                    "fc-daygrid-event-harness" + (y ? " fc-daygrid-event-harness-abs" : ""),
                  key: m,
        ...
        for (let o of e) {
          ...
          s.push(
            f(
              ...
              "bg-event" === t ? f(ao, Object.assign({ seg: o }, di(o, r))) : co(t)
            )
          );
        }
      return f(m, {}, ...s);
  ...
  class pl extends ns {
    constructor() {
      (super(...arguments), (this.slicer = new gl()), (this.tableRef = { current: null }));
    }
    render() {
      let { props: e, context: t } = this;
      return f(
  ...
  function Dl(e) {
    ...
    return f(Bn.Consumer, null, (n) => {
      if (!e.isLabeled) return f("td", { className: t.join(" "), "data-time": e.isoTimeStr });
  ...
  class Cl extends Un {
    render() {
      return this.props.slatMetas.map((e) => f("tr", { key: e.key }, f(Dl, Object.assign({}, e))));
    }
  }
          ...
          chunks: [
            {
              key: "axis",
              rowContent: (e) =>
                f("tr", { role: "presentation" }, this.renderHeadAxis("day", e.rowSyncHeights[0])),
            },
            {
              key: "cols",
              elRef: this.headerElRef,
            ...
            chunks: [
              {
                key: "axis",
                rowContent: (e) =>
                  f("tr", { role: "presentation" }, this.renderTableRowAxis(e.rowSyncHeights[0])),
              },
              { key: "cols", content: t },
            ],
          }),
  ...
  function Hl(e, t, n) {
    ...
    let i = os(r.addSegs(e)),
      s = (function (e) {
        ...
        return Bl(t.length ? { level: 0, lateralStart: 0, lateralEnd: t[0].length } : null, n)[0];
      })(r);
    return (
      (s = (function (e, t) {
        const n = Ul(
      ...
      return f(
        ...
        (t) =>
          f(
            ...
            f("div", { className: "fc-timegrid-col-events" }, this.renderFgSegs(o, s, !1, !1, !1)),
            f(
              "div",
              { className: "fc-timegrid-col-events" },
              this.renderFgSegs(i, {}, Boolean(e.eventDrag), Boolean(e.eventResize), Boolean(r))
            ),
            f(
              "div",
              { className: "fc-timegrid-now-indicator-container" },
      ...
      return f(
        ...
        y.map((e) => {
          ...
          return f(
            ...
            {
              className:
                "fc-timegrid-event-harness" + (v ? " fc-timegrid-event-harness-inset" : ""),
              key: l,
              style: Object.assign(Object.assign({ visibility: c ? "" : "hidden" }, d), m),
            },
            f(
              Fl,
              Object.assign(
      ...
      let { props: n, context: r } = this,
        i = Wl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
          ...
          return f(
            ...
            "bg-event" === t
              ? f(ao, Object.assign({ seg: s }, di(s, n.todayRange, n.nowDate)))
              : co(t)
          );
        });
      return f(m, null, i);
  ...
  const Kl = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
      ...
      timeGrid: {
        component: class extends xl {
          ...
          render() {
            ...
            return d
              ? this.renderHScrollLayout(u, h, g, s.colCnt, l, a, this.state.slatCoords)
  ...
  function dc(e) {
    let t = Rt(e.renderRange.start),
      ...
      r = [],
      i = [];
    for (; t < n; ) (r.push(t), i.push({ start: t, end: bt(t, 1) }), (t = bt(t, 1)));
        ...
        component: class extends ns {
          ...
          renderEmptyMessage() {
            ...
            return f(
              ...
              (e) => f(e, { elTag: "div", elClasses: ["fc-list-empty-cushion"] })
            );
          }
          renderSegList(e, t) {
            ...
            return f(Es, { unit: "day" }, (e, l) => {
              ...
              for (let n = 0; n < a.length; n += 1) {
                ...
                if (d) {
                  let a = Ht(t[n]),
                    u = o + "-" + a;
                  (c.push(f(ic, { key: a, cellId: u, dayDate: t[n], todayRange: l })),
                    (d = ii(d, r.eventOrder)));
                  for (let t of d)
                    c.push(
                      f(
          ...
          _eventStoreToSegs(e, t, n) {
            return this.eventRangesToSegs(
              Jr(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold)
                .fg,
              n
            );
          }
                  ...
                  f(
                    ...
                    (t, n, r, i) => (
                      ...
                      f(
                        ...
                        f(Sa, Object.assign({ isHeightAuto: r, forPrint: i }, e))
                      )
                    )
                  ),
                  this.el
