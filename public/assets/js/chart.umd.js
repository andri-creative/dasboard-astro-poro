...
!(function (t, e) {
  ...
  function pt(t, e, i) {
    ...
    if (t._sorted) {
      ...
      (d &&
        (n = J(
          Math.min(it(r, a.axis, h).lo, i ? s : it(e, l, a.getPixelForValue(h)).lo),
          0,
          s - 1
        )),
        (o = u
      ...
      (function (t, e) {
        ...
        for (i = 0, s = t.length; i < s; ++i)
          ((a = o),
            ...
            o &&
              ((n = t[i]),
              a && ((n.cp1x = ri(n.cp1x, e.left, e.right)), (n.cp1y = ri(n.cp1y, e.top, e.bottom))),
              r &&
                ((n.cp2x = ri(n.cp2x, e.left, e.right)), (n.cp2y = ri(n.cp2y, e.top, e.bottom)))));
      })(t, i);
  }
  const hi = (t) => 0 === t || 1 === t,
    ...
    ui = {
      ...
      easeInOutBounce: (t) =>
        t < 0.5 ? 0.5 * ui.easeInBounce(2 * t) : 0.5 * ui.easeOutBounce(2 * t - 1) + 0.5,
    };
  function fi(t, e, i, s) {
      ...
      ((m = e[t % a]),
        m.skip ||
          ...
          p !== b &&
            ...
            null !== _ &&
              v() &&
              (g.push(Ti({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
            (i = t),
            (b = p))));
  ...
  class Vs {
    ...
    applyStack(t, e, i) {
      const s = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return Os({ keys: Cs(s, !0), values: e._stacks[t.axis]._visualValues }, o, n.index, {
        mode: i,
      });
    }
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        l = ((t, e, i) => t && !e.hidden && e._stacked && { keys: Cs(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
  ...
  class Ks extends Bs {
    ...
    update(t, e, i) {
      ...
      (this._convertTicksToLabels(r ? $s(this.ticks, a) : this.ticks),
        ...
        o.display &&
          ...
          ((this.ticks = Ns(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
        ...
        if (
          ...
          if (n(g))
            for (d = 0, f = g.length; d < f; ++d)
              ((v = g[d]), s(v) || n(v) || ((_ = De(o, b.data, b.gc, _, v)), (y += x)));
    ...
    drawBorder() {
      ...
      let l, h, c, d;
      (this.isHorizontal()
        ? ((l = Oe(t, this.left, o) - o / 2), (h = Oe(t, this.right, a) + a / 2), (c = d = r))
        : ((c = Oe(t, this.top, o) - o / 2), (d = Oe(t, this.bottom, a) + a / 2), (l = h = r)),
        e.save(),
        (e.lineWidth = n.width),
  ...
  function An(t, e, i, s) {
    ...
    let h, c, d, u;
    for (h = i, c = i + s; h < c; ++h)
      ((u = e[h]), (d = {}), (d[n.axis] = r || n.parse(a[h], h)), l.push(On(u, d, o, h)));
    return l;
  }
  function Tn(t) {
  ...
  function En(t, e, i, s) {
    ...
    return (
      s
        ? ((a = i), (t = Rn((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
        : (t = Rn(t, e, i)),
      t
    );
  }
  ...
  var Vn = Object.freeze({
    ...
    BarController: class extends Vs {
      ...
      parseObjectData(t, e, i, s) {
        ...
        let d, u, f, g;
        for (d = i, u = i + s; d < u; ++d)
          ((g = e[d]), (f = {}), (f[n.axis] = n.parse(M(g, l), d)), c.push(On(M(g, h), f, o, d)));
        return c;
      }
      updateRangeFromParsed(t, e, i, s) {
  ...
  class Zn extends Bs {
    ...
    draw(t, e, i, s) {
      ...
      ((this.points || []).length && n.borderWidth && (t.save(), Gn(t, this, i, s), t.restore()),
            ...
            for (let o = e - 1; o >= 0; o--) {
              ...
              if (!s(g)) {
                ...
                Object.values(t).some((t) => 0 !== t)
                  ? (i.beginPath(), We(i, { x: n, y: o, w: a, h: r, radius: t }), i.fill())
                  : i.fillRect(n, o, a, r);
              }
  ...
  function Ao(t, e) {
    ...
    return (
      ...
      null === l
        ...
        : (o &&
            (l =
              "week" !== o || (!W(r) && !0 !== r) ? i.startOf(l, o) : i.startOf(l, "isoWeek", r)),
          +l)
    );
  }
  function To(t, e, i, s) {
    ...
    CategoryScale: class extends Ks {
      ...
      parse(t, e) {
        ...
        return ((t, e) => (null === t ? null : J(Math.round(t), 0, e)))(
          (e = isFinite(e) && i[e] === t ? e : ao(i, t, l(e, t), this._addedLabels)),
          i.length - 1
        );
      }
      determineDataLimits() {
  ...
  var jo = {
    ...
    beforeLayout(t, e, i) {
      ...
      if (
        !i.forceOverride &&
        (Ho(s) || ((a = n) && (a.borderColor || a.backgroundColor)) || (o && Ho(o)))
      )
        return;
      var a;
      const r = Wo(t);
