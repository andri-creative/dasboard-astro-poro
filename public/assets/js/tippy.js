...
(function (global, factory) {
  ...
  function validateTargets(targets) {
    ...
    var didPassPlainObject =
      Object.prototype.toString.call(targets) === "[object Object]" && !targets.addEventListener;
    errorWhen(
      didPassFalsyValue,
      [
        "tippy() was passed",
  ...
  function evaluateProps(reference, props) {
    ...
    out.aria = {
      ...
      content:
        out.aria.content === "auto" ? (props.interactive ? null : "describedby") : out.aria.content,
    };
    return out;
  }
  ...
  function render(instance) {
    ...
    function onUpdate(prevProps, nextProps) {
      ...
      box.style.maxWidth =
        typeof nextProps.maxWidth === "number" ? nextProps.maxWidth + "px" : nextProps.maxWidth;
  ...
  function createTippy(reference, passedProps) {
    ...
    function getIsDefaultRenderFn() {
      ...
      // @ts-ignore
      return !!(
        (_instance$props$rende = instance.props.render) != null && _instance$props$rende.$$tippy
      );
    }
