(!(function ($) {
  ...
  $.fn.vectorMap = function (options) {
    ...
    if ("addMap" === options) jvm.Map.maps[arguments[1]] = arguments[2];
      ...
      if (("set" === options || "get" === options) && apiParams[options][arguments[1]])
        return map[options + (arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1))].apply(
          map,
  ...
  (function (factory) {
    ...
    function shouldAdjustOldDeltas(orgEvent, absDelta) {
      return (
        special.settings.adjustOldDeltas && "mousewheel" === orgEvent.type && absDelta % 120 == 0
      );
    }
    $.fn.extend({
...
((jvm.$ = jQuery),
  ...
  (jvm.SVGImageElement.prototype.applyAttr = function (attr, value) {
    ...
    "image" == attr
      ...
      : "cx" == attr
        ? ((this.cx = value),
          this.width && this.applyAttr("x", value - this.width / 2 + this.offset[0]))
        : "cy" == attr
          ? ((this.cy = value),
            this.height && this.applyAttr("y", value - this.height / 2 + this.offset[1]))
  ...
  (jvm.VMLCanvasElement.prototype.setSize = function (width, height) {
    ...
    if (
      ...
      for (
        i = 0, l = (paths = this.rootElement.node.getElementsByTagName("shape")).length;
        i < l;
        i++
      )
  ...
  (jvm.NumericScale.prototype = {
    ...
    getTicks: function () {
      var tick,
        ...
        ticks = [];
      for (
        err <= 0.15 ? (step *= 10) : err <= 0.35 ? (step *= 5) : err <= 0.75 && (step *= 2),
        ...
        ((v =
          tick == extent[0] ? this.clearMinValue : tick == extent[1] ? this.clearMaxValue : tick),
      ...
      switch (
        ...
        case "image":
          sample.css(
            "background",
            "url(" +
              ("object" == typeof ticks[i].value ? ticks[i].value.url : ticks[i].value) +
          ...
          function (e) {
            var type =
                ...
                (jvm.$(this).attr("class").baseVal || jvm.$(this).attr("class")).indexOf(
                  ...
                  : "region",
              code =
                "region" == type ? jvm.$(this).attr("data-code") : jvm.$(this).attr("data-index"),
          ...
          mouseMoved ||
            ...
            (("region" == type && map.params.regionsSelectable) ||
              ...
              (clickEvent.isDefaultPrevented() ||
                (map.params[type + "sSelectableOne"] && map.clearSelected(type + "s"),
        ...
        this.params.maxLevel > config.multiMapLevel &&
          this.maps[name].container.on(
            ...
            function (e, code) {
              ...
              (multimap.drillDownPromise && "pending" === multimap.drillDownPromise.state()) ||
